...
from .views import new_order , get_orders , single_order ,change_order_status,delete_order

app_name = "order"
urlpatterns = [
path('new_order/',new_order, name='order-create'),
path('orders/',get_orders , name="get_all_orders"),
...
path('order/<str:pk>/delete/',delete_order , name="change_order_status"),
