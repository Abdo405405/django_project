...
def new_order (request):
    try:
      ...
      if not order_items or  len(order_items)==0 :
        ...
        payment_type = User_Payment_Method.objects.get(user = customer.user , id = data["payment_id"])
        ...
        return Response(serializer.data)
              ...
              return Response({'error': f" Payment_Method with id {customer_id } does not exist For this customer"}, status=status.HTTP_400_BAD_REQUEST)
